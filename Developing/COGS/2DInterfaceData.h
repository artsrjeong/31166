...
//#define MAX_CALL  128				// max number of destination entry calls a plan can have
#define MAX_CALL  512				// max number of destination entry calls a plan can have
...
struct Parameter						// static global parameters		
{
	...
	ULONG A1S,A2S,A1W,A2W,V,W;			// parameter for scoring
...
struct CarCommand
{
	...
	unsigned char stopType;	// stop type
};
