...
__declspec(dllexport) void HPEInitialize(BuildingInfo *mBdInfo,HoistwayInfo *mHwyInfo,CarInfo *mCarInfo,Parameter *mParam,char* version)
{
...
__declspec(dllexport) UCHAR PutHallCall(UCHAR carIndex, Call *mCall) 
{
 ...
 ********************************************************************************************/
__declspec(dllexport) void PutPlan(unsigned char HW_index,HoistwayPlan *plan)
{
	for(int i=0;i<2;i++)
	{
 ...
 ********************************************************************************************/
__declspec(dllexport) void GetPlan(unsigned char HW_index,HoistwayPlan * plan)
{
	for(int i=0;i<2;i++)
	{
		for(int j=0;j<MAX_STOP;j++)
...
__declspec(dllexport) void PutCarState(UCHAR carIndex,CarState *car)
{
 ...
 ********************************************************************************************/
__declspec(dllexport) void GetCarState(UCHAR carIndex,CarState *carState)
{
 ...
 ********************************************************************************************/
__declspec(dllexport) void ExecutePlan(unsigned char HW_index)
{
