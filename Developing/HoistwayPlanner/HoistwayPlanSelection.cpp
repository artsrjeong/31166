...
{	// needs implementation details // shs
	...
	tpredIndex=plan.sequences[leadCar].sequence[direct.predecessor].index;
...
T_HPSCORE HoistwaySchedule::getPOIScore() 
{
	...
	{
		return T_HPSCORE_MAX; // 3.402823466E38F; it is maximum of float but use maximum of long
	}
	else
		return 0;
