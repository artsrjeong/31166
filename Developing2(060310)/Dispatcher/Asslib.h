...
// std call set for expected car calls
#define         DBD_SNONE       0x00
#define         DBD_SUCC        0x01
#define         DBD_SDCC        0x02

#define         DBD_SFUCC        0x01   //Standard Front Up    Dst car Call
#define         DBD_SFDCC        0x02   //Standard Front Down  Dst car Call
#define         DBD_SRUCC        0x04   //Stnndard Rear  Up    Dst car Call
#define         DBD_SRDCC        0x08   //Standard Rear  Down  Dst car Call

#define         DBD_SCCS        DBD_SFUCC | DBD_SFDCC | DBD_SRUCC | DBD_SRDCC

// support of handicap calls  for expected car calls
#define         DBD_ENONE       0x00
#define         DBD_EUCC        0x10
#define         DBD_EDCC        0x20

#define         DBD_EFUCC        0x10   //Extend   Front Up    Dst car Call
#define         DBD_EFDCC        0x20   //Extend   Front Down  Dst car Call
#define         DBD_ERUCC        0x40   //Extend   Rear  Up    Dst car Call
#define         DBD_ERDCC        0x80   //Extend   Rear  Down  Dst car Call

#define         DBD_ECCS        DBD_EFUCC | DBD_EFDCC | DBD_ERUCC | DBD_ERDCC

// any expected car calls
#define         DBD_AUCC        (DBD_SUCC | DBD_EUCC)
#define         DBD_ADCC        (DBD_SDCC | DBD_EDCC)
...
EXTERN BYTE_T asslib_CheckEzRunTime(BYTE_T car, BYTE_T pos1, BYTE_T pos2);
...
EXTERN FLAG_T asslib_ValidExpectCalls(BYTE_T car,BYTE_T dir,BYTE_T pos,BYTE_T *expectCnts);
...
EXTERN void asslib_assign_local_call(BYTE_T car, WORD_T callmask, BYTE_T pos);
