...
#include "..\common\2DInterfaceData.h"	// Added by ClassView
...
//	int i_lobby;//lobby floor index  // AH: replaced by Param.lobby
	...
	// Function to call IHC(Intra-Hoistway Coordinator)
	HINSTANCE hinstIHC;
	int LinkIHC(CString IHCDLLFileName);
	IHCInitialize_T IHCInitialize;
	HPEInitialize_T HPEInitialize;
	PutCarStateDLL_T	PutCarStateDLL;
	MonitorCarState_T	MonitorCarState;
	AcceptAssignmentDLL_T	AcceptAssignmentDLL;
