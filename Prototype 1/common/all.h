...
/*-----------------------------------------------------------------------*/
#include "switch.h"             // project specific switches // CSW: Not used in 2D dispatching project

/*-----------------------------------------------------------------------
|  Standard Boolean Type (use for new code)
-------------------------------------------------------------------------*/
// typedef unsigned char   BOOL;  // CSW: conflict with WinDef.h. use keyword bool instead
#ifndef	VCPP			// avoid redefinition with VC++
...
typedef char   CHAR;           // 1 byte //CSW: remove 'signed' to be compatible with Windows
...
// #define INT             SHORT		// CSW: incompatible with VC++, not using it for now. 
